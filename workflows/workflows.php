...
/**
 * Class Disciple_Tools_Chatwoot_Workflows
 *
 * @since  1.11.0
 */
class Disciple_Tools_Chatwoot_Workflows {
    ...
    /**
     * Disciple_Tools_Chatwoot_Workflows The single instance of Disciple_Tools_Chatwoot_Workflows.
     *
     * @var    object
     * @access private
     * @since  1.11.0
    ...
    /**
     * Main Disciple_Tools_Chatwoot_Workflows Instance
     *
     * Ensures only one instance of Disciple_Tools_Chatwoot_Workflows is loaded or can be loaded.
     *
     * @return Disciple_Tools_Chatwoot_Workflows instance
     * @since  1.11.0
     */
    ...
    /**
     * Disciple_Tools_Chatwoot_Workflows constructor.
     */
    ...
    private function build_default_workflows_starter( &$workflows ) {
        $dt_fields = DT_Posts::get_post_field_settings( 'chatwoot_post_type' );
        ...
        $workflows[] = (object) [
            ...
            'actions'    => [
                Disciple_Tools_Workflows_Defaults::new_action( Disciple_Tools_Workflows_Defaults::$action_update,
                    [
                        'id'    => 'disciple_tools_chatwoot_text',
                        'label' => $dt_fields['disciple_tools_chatwoot_text']['name']
                    ], [
...
Disciple_Tools_Chatwoot_Workflows::instance();
